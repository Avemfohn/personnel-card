...
const PersonelForm = (props: PersonelFormPropsType) => {
    ...
    const {register, handleSubmit, formState: {errors, isSubmitting, isDirty, isSubmitSuccessful}, control,setValue,watch,getValues, reset} = useForm<Personel>({
        defaultValues
    });
                         ...
                         <div className="col-span-6 sm:col-span-2">
                            <label htmlFor="image" className="block text-sm font-medium text-gray-700 dark:text-white">
                             ...
                             <div className="flex items-center">
                                 {props.personel?.image &&<Image src={props.personel?.image} width={100} height={100}/> }
                             </div>
                            <input
                                type="file"
                                {...register("image",
